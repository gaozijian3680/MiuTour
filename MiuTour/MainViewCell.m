...
- (void)loadSubviews
{
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(10, 10, ScreenWidth - 20, 220)];
...
//    [imageView addSubview:visualEffect];
    ...
    UIView *visualEffectView = [[UIView alloc]initWithFrame:CGRectMake(200, 0, ScreenWidth - 200, 130)];
